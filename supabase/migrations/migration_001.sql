...
CREATE TABLE IF NOT EXISTS public.prompts_vault (
    ...
    model_name  TEXT         DEFAULT NULL,                  -- Modelo/ferramenta de IA utilizada (ex: Midjourney, Gemini)
...
COMMENT ON COLUMN public.prompts_vault.model_name  IS 'Nome do modelo/ferramenta de IA utilizada para gerar a imagem (ex: Midjourney, DALL-E, Gemini).';
